...
public class PostScreenController : MonoBehaviour {
    ...
    private DelayGramSerializer delayGramSerializer;
    ...
    void Awake()
    {
        this.delayGramSerializer = DelayGramSerializer.Instance;
    ...
    public void EnterScreen()
    {
        ...
        if (this.delayGramSerializer.NextPostTime > DateTime.Now) {
    ...
    {
        var posts = delayGramSerializer.GetReverseChronologicalPosts();
    ...
    private GameObject SetupPostPrefab(DelayGramPost post, float yPosition, GameObject scrollArea)
    {
        ...
        if (postPrefab)
        {
            ...
            {
                GameObject avatar;
                switch (post.characterProperties.gender)
                {
                    case Gender.Male:
                        avatar = profilePicBubble.transform.Find("MaleAvatar").gameObject;
                        profilePicBubble.transform.Find("FemaleAvatar").gameObject.SetActive(false);
                        break;
                    case Gender.Female:
                    default:
                        avatar = profilePicBubble.transform.Find("FemaleAvatar").gameObject;
                        profilePicBubble.transform.Find("MaleAvatar").gameObject.SetActive(false);
                        break;
                }
                avatar.SetActive(true);
                var avatarCustomization = avatar.GetComponent<CharacterCustomization>();
                avatarCustomization.SetCharacterLook(post.characterProperties);
            }
    ...
    private void UpdateTimeRemaining()
    {
        ...
        {
            var timeTillCanPost = delayGramSerializer.NextPostTime - DateTime.Now;
