...
public class EventController : MonoBehaviour
{
    ...
    private DelayGramSerializer _dgSerializer;
    ...
    void Start () {
        ...
        this._dgSerializer = DelayGramSerializer.Instance;
        this._dgSerializer.RegisterFollowersListener(this);
        this._oldFollowerAmount = _dgSerializer.Followers;
    ...
    void OnDestroy()
    {
        _dgSerializer.UnregisterFollowersListener(this);
    }
